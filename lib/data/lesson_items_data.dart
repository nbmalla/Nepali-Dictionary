...
final Map<String, List<LessonItem>> lessonItemsByCategory = {
  ...
  'jlpt_n5_vocab': const [
    ...
    // 代名詞 (सर्वनाम / pronouns, demonstratives, question words)
    ...
    // 家族 (परिवार / family members — referring to one's own family)
    ...
    // 自然・天気 (प्रकृति/मौसम / nature & weather)
    ...
    // 身につけるもの (लगाउने वस्तु / clothes & accessories)
    ...
    // 身の回りの物 (दैनिक प्रयोगका वस्तु / everyday items)
    ...
    // 仕事・学校の物 (काम/स्कुलका वस्तु / work & school)
    ...
    // 形容詞 (विशेषण / colors as い-adjectives, and taste words)
