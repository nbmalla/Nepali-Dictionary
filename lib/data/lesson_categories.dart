...
const List<LessonCategory> lessonCategories = [
  ...
  LessonCategory(id: 'jlpt_n5_grammar', icon: Icons.rule_outlined, jpLabel: 'JLPT N5 文法', neLabel: 'JLPT N5 व्याकरण', subtitle: '文の作り方(パターン+例文)'),
  LessonCategory(id: 'jlpt_n5_fill_blank', icon: Icons.edit_note_outlined, jpLabel: 'JLPT N5 穴埋め問題', neLabel: 'JLPT N5 रिक्तस्थान भर्ने अभ्यास', subtitle: '文法の実践問題'),
  LessonCategory(id: 'jlpt_n5_kanji_numbers', icon: Icons.numbers, jpLabel: 'JLPT N5 漢字:数字・時間', neLabel: 'JLPT N5 कान्जी: अंक/समय', subtitle: '読み方(音読み・訓読み)+例'),
  LessonCategory(id: 'jlpt_n5_kanji_people_place', icon: Icons.people_alt_outlined, jpLabel: 'JLPT N5 漢字:人・場所', neLabel: 'JLPT N5 कान्जी: मानिस/स्थान', subtitle: '読み方(音読み・訓読み)+例'),
  LessonCategory(id: 'jlpt_n5_kanji_nature_verbs', icon: Icons.terrain_outlined, jpLabel: 'JLPT N5 漢字:自然・動作', neLabel: 'JLPT N5 कान्जी: प्रकृति/क्रिया', subtitle: '読み方(音読み・訓読み)+例'),
  LessonCategory(id: 'jlpt_n5_kanji_adj_other', icon: Icons.style_outlined, jpLabel: 'JLPT N5 漢字:様子・体など', neLabel: 'JLPT N5 कान्जी: विशेषण/शरीर आदि', subtitle: '読み方(音読み・訓読み)+例'),
